          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="{{ route('register') }}" method="POST"
                  ...
                  <label for="contribution_plan" class="form-label">
                    ...
                    <small>
                      <em>
                        ...
                        terlibat,
                        indikator keberhasilan, jangka waktu pelaksanaan, bentuk konkrit kegiatannya, semakin jelas
                        semakin
                        baik
                        ya)
                      </em>
                ...
                <div class="mb-3">
                  <label for="skill" class="form-label">Keahlian/keterampilan diri yang telah
                    diimplementasikan</label>
                ...
                <div class="mb-3">
                  ...
                  <select class="form-control @error('contribution_location') is-invalid @enderror"
                    ...
                    <option value="Medan" {{ old('contribution_location') == 'Medan' ? 'selected' : '' }}>Medan
                    </option>
        ...
        @else
          <div class="card">
            <div class="card-body text-center">
              ...
              <a href="{{ route('login') }}" class="btn btn-danger btn-sm">Login ke Dashboard</a>
            </div>
          </div>
        @endif
        <!-- Register Card -->
